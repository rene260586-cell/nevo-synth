...
function flxMappingPayload(){return {app:'NÉVO Studio',version:'4.1.3',profile:'DDJ-FLX4',createdAt:new Date().toISOString(),mappings:flxState.mappings}}
...
v410RefreshFx();
console.info('NÉVO v4.1.3: channel strips beside playlist active');


// ===== v4.1.3: larger jogs + playlist-first center + compact mapping drawer =====
...
console.info('NÉVO v4.1.3: deck channel strips, compact master mapping and playlist center active');
