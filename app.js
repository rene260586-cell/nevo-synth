...
function flxMappingPayload(){return {app:'NÉVO Studio',version:'4.1.8',profile:'DDJ-FLX4',createdAt:new Date().toISOString(),mappings:flxState.mappings}}
...
// ===== v4.1.8: compact vertical Beat FX rail + real Level/Depth screen knob =====
...
console.info('NÉVO v4.1.8: compact vertical Beat FX rail active');
